...
if __name__ == "__main__":
    ...
    Jcat_stem = paths.get_catalog_stem(field, tile, "J", prefix=args.prefix, suffix="_init")
    ...
    Kcat_stem = paths.get_catalog_stem(field, args.tile, "K", prefix=args.prefix, suffix="_init") 
